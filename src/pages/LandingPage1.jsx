...
function LandingPage1() {
  ...
  return (
   ...
   <Row className='mt-5 mb-5 d-flex justify-content-center  align-items-center'>
    ...
    <p style={{textAlign:'justify'}}className='mt-3' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem id sit ad voluptates aliquam facilis saepe aliquid quae maxime, qui ipsum? Corrupti vitae aspernatur fugit pariatur porro ut illo magni.</p>
...
  </div>
   ...
   <Row>
    <Col lg={5}>
      ...
      <h6 className='mb-3'><span className='fw-bolder fs-5'>Play Everything</span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae veniam temporibus saepe suscipit fugiat libero excepturi esse molestias animi, nam error, velit unde dicta minus laboriosam, earum quibusdam eaque placeat!</h6>
      <h3>Simple fast and Powerful</h3>
      <h6 className='mb-3'><span className='fw-bolder fs-5'>Play Everything</span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae veniam temporibus saepe suscipit fugiat libero excepturi esse molestias animi, nam error, velit unde dicta minus laboriosam, earum quibusdam eaque placeat!</h6>
      <h3>Simple fast and Powerful</h3>
      <h6 className='mb-3'><span className='fw-bolder fs-5'>Play Everything</span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae veniam temporibus saepe suscipit fugiat libero excepturi esse molestias animi, nam error, velit unde dicta minus laboriosam, earum quibusdam eaque placeat!</h6>
